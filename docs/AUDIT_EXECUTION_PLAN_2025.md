...
<html lang="ru">
  <head>
    ...
    <meta
      name="description"
      content="Лучшие скидки на {{categoryName}} с AliExpress. {{count}} товаров со скидками до 90%. Бесплатная доставка."
    />
...
<body>
  <div class="item-page">
    ...
    <main class="item-main">
      ...
      <div class="item-info">
        ...
        <div class="item-social-proof">
          <span
            >🔥 <span class="viewers-count">{{random 15-200}}</span> человек смотрят сейчас</span
          >
        </div>
        ...
        <div class="item-shipping">Бесплатная доставка из Китая — 15-30 дней</div>
        ...
        <div class="item-actions">
          ...
          <p class="item-affiliate-note">💡 Партнёрская ссылка. Цена для вас не меняется.</p>
          <a href="/" class="item-back-btn">← Все скидки</a>
        </div>

        <!-- Share -->
        <button class="item-share-btn" onclick="shareProduct({{id}})">📤 Поделиться</button>
      </div>
    </main>
    ...
    <section class="item-description">
      <h2>Описание</h2>
      <p>
        {{title}} — товар со скидкой {{discount}}% на AliExpress. Рейтинг {{rating}}⭐, {{orders}}
        заказов. Бесплатная доставка.
      </p>
    </section>
    ...
    <div class="sticky-cta mobile-only">
      ...
      <a href="{{deeplink}}" class="sticky-btn" target="_blank"> Купить на AliExpress </a>
    </div>
...
_Документ составлен на основе аудита SmartSkidka.ru от 14.05.2026_
